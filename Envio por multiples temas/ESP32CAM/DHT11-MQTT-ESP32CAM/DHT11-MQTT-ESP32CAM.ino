...
const char* mqtt_server = "172.16.22.16"; // Si estas en una red local, coloca la IP asignada, en caso contrario, coloca la IP publica
IPAddress server(172,16,22,16);
